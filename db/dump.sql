...
-- Cookbooks creation 
INSERT INTO cookbooks (owner_id, name) VALUES (2, "Breakfast");
INSERT INTO cookbooks (owner_id, name) VALUES (2, "Lunch");
INSERT INTO cookbooks (owner_id, name) VALUES (2, "Dinner");
...
INSERT INTO kitchens_cookbooks (kitchen_id, cookbook_id) VALUES (1, 3);
INSERT INTO kitchens_cookbooks (kitchen_id, cookbook_id) VALUES (2, 4);
...
-- Example recipe 2 (contains "tomato" in name to display multiple results)
...
INSERT INTO recipes (name, description, category, cuisine, ingredients, instructions, prep_time, cook_time, total_time, servings, creator_id)
Values('Test1', "Test1 recipe", "Testing", "QA", "1 Test data|2 Test code|3 Test users", "1 Test prep|2 Test work|3 Test consume", 0, 0, 0, 0, 1);

INSERT INTO recipes (name, description, category, cuisine, ingredients, instructions, prep_time, cook_time, total_time, servings, creator_id)
Values('Test3', "Test3 recipe", "Testing", "QA", "1 Test data|2 Test code|3 Test users", "1 Test prep|2 Test work|3 Test consume", 0, 0, 0, 0, 1);

-- Cookbook testing
INSERT INTO cookbooks_recipes (cookbook_id, recipe_id) VALUES (1, 4); 
INSERT INTO cookbooks_recipes (cookbook_id, recipe_id) VALUES (2, 1);
INSERT INTO cookbooks_recipes (cookbook_id, recipe_id) VALUES (2, 2);
INSERT INTO cookbooks_recipes (cookbook_id, recipe_id) VALUES (3, 3);
INSERT INTO cookbooks_recipes (cookbook_id, recipe_id) VALUES (4, 3);
